...
CREATE TABLE Courses (course_id INT PRIMARY KEY, course_name VARCHAR(100) NOT NULL, dept_id INT NOT NULL, FOREIGN KEY (dept_id) REFERENCES Departments(dept_id));
...
GRANT SELECT ON db_43stwuf2f.Courses TO 'viewer_user'@'bytexldb.com';
